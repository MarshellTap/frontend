...
// node_modules/ton-ui-vue/dist/index.mjs
...
var TonConnectUIVueError = class _TonConnectUIVueError extends TonConnectUIError {
  constructor(...args) {
    super(...args);
    Object.setPrototypeOf(this, _TonConnectUIVueError.prototype);
  }
};
var TonConnectProviderNotSetError = class _TonConnectProviderNotSetError extends TonConnectUIVueError {
  constructor(...args) {
    super(...args);
    Object.setPrototypeOf(this, _TonConnectProviderNotSetError.prototype);
  }
};
var checkProvider = (provider) => {
  if (!provider) {
...
var TonConnectUIContext = Symbol("TonConnectUIContext");
var TonConnectUIOptionsContext = Symbol("TonConnectUIOptionsContext");
var tonConnectUI = null;
function createTonConnectUIProvider(options) {
  const tonConnectUIRef = ref(null);
...
function useTonConnectUIProvider() {
  const tonConnectUI2 = inject(TonConnectUIContext);
...
function useTonWallet() {
  ...
  const wallet = ref(
    ((_a2 = tonConnectUI2.value) == null ? void 0 : _a2.wallet) || null
  );
...
function useTonConnectModal() {
  ...
  const { tonConnectUI: tonConnectUI2 } = useTonConnectUI();
  const state = ref(
    ((_a2 = tonConnectUI2.value) == null ? void 0 : _a2.modal.state) || null
  );
  ...
  const open = () => {
    var _a22;
    (_a22 = tonConnectUI2.value) == null ? void 0 : _a22.modal.open();
  };
  const close = () => {
    var _a22;
    (_a22 = tonConnectUI2.value) == null ? void 0 : _a22.modal.close();
  };
  return {
    state,
    open,
...
function useSendTransaction() {
  ...
  const sendTransaction = () => __async2(this, null, function* () {
    var _a2;
    if (!tonConnectUI2.value) {
    ...
    try {
      ...
      if ((_a2 = err == null ? void 0 : err.message) == null ? void 0 : _a2.includes("User rejects the action")) {
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", {
    ...
    style: normalizeStyle(__spreadValues2({ width: "fit-content" }, _ctx.style))
  }, null, 14, _hoisted_1);
}
var TonConnectButton = _export_sfc(_sfc_main, [["render", _sfc_render]]);
var isClient = () => {
...
@tonconnect/ui/lib/index.mjs:
   ...
   *)
*/
//# sourceMappingURL=ton-ui-vue.js.map
