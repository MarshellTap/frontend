...
const skeletonJson = new URL('~/assets/spine/skeleton2.json', import.meta.url).href;
const skeletonAtlas = new URL('~/assets/spine/skeleton2.atlas', import.meta.url).href;
// const skeletonJson = '/assets/spine/skeleton.json';
// const skeletonAtlas = '/assets/spine/skeleton.atlas';
